...
### Test 3 : Recherche "Selenium WebDriver"
**Description** : Effectue une recherche et vérifie les résultats.

![Résultats Selenium](screenshots/Test3_ResultatsRecherche_SeleniumWebDriver.png)

---

### Test 4 : Recherche "Java Programming"
**Description** : Vérifie la présence des résultats de recherche.

![Résultats Java](screenshots/Test4_ResultatsRecherche_JavaProgramming.png)

---

## 📸 Activité 10 : Plan de Test - Recherche Google

### CT-001 : Recherche avec mot clé valide
**Données** : "Selenium WebDriver"  
**Résultat attendu** : Des résultats s'affichent

![CT-001](screenshots/CT001_RechercheMotCleValide.png)

---

### CT-002 : Champ de recherche vide
**Données** : (vide)  
**Résultat attendu** : L'utilisateur reste sur Google

![CT-002](screenshots/CT002_ChampVide.png)

---

### CT-003 : Longue chaîne de caractères
**Données** : Chaîne de 150+ caractères  
**Résultat attendu** : Pas d'erreur

![CT-003](screenshots/CT003_LongueChaineCaracteres.png)

---

### CT-004 : Caractères spéciaux
**Données** : "@#$%^&*!?"  
**Résultat attendu** : Pas d'erreur serveur

![CT-004](screenshots/CT004_CaracteresSpeciaux.png)

---

### CT-005 : Filtre Images
**Données** : "paysage montagne"  
**Résultat attendu** : Navigation vers Google Images

![CT-005](screenshots/CT005_FiltreImages_Alternative.png)

---

### CT-006 : Suggestions de recherche
**Données** : "selenium"  
**Résultat attendu** : Des suggestions apparaissent

![CT-006](screenshots/CT006_SuggestionsRecherche.png)

---

### CT-007 : Recherche paramétrée - Java
**Données** : "Java programming"

![CT-007 Java](screenshots/CT007_Recherche_Java.png)

---

### CT-007 : Recherche paramétrée - Python
**Données** : "Python programming"

![CT-007 Python](screenshots/CT007_Recherche_Python.png)

---

### CT-007 : Recherche paramétrée - JavaScript
**Données** : "JavaScript programming"

![CT-007 JavaScript](screenshots/CT007_Recherche_JavaScript.png)
